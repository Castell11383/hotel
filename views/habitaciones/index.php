<h1 class="text-center" style="font-family: 'Montserrat', sans-serif; font-size: 2rem; font-weight: bold; color: #333;">Habitaciones</h1>
    ...
    <?php foreach($habitaciones as $habitacion) { ?>
        <div class="habitacion-card col-md-4 mb-4" 
            ...
            <img src="<?php echo htmlspecialchars($habitacion['habi_imagen']); ?>" 
                 alt="<?php echo htmlspecialchars($habitacion['habi_tipo']); ?>" 
                 class="img-fluid" 
                 style="transition: transform 0.3s ease-in-out; width: 100%; height: 250px; object-fit: cover; border-radius: 10px;">

            <h2 style="font-family: 'Montserrat', sans-serif; font-size: 1.5rem; font-weight: bold; text-align: center; color: #333; margin-top: 15px;">
                <?php echo htmlspecialchars($habitacion['habi_tipo']); ?>
            </h2>

            <p style="font-family: 'Open Sans', sans-serif; font-size: 1rem; text-align: center; color: #555; margin: 10px 0;">
